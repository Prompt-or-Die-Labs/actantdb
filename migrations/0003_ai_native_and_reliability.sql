-- ============================================================================
-- 0003_ai_native_and_reliability.sql — Phase 1+ schema delta
--
-- Adds: ActantIndex (retrieval), Protocols (MCP/A2A/AP2), Observability
-- (OTel/OpenInference correlation), and Reliability primitives
-- (Throttle/Queue/Retry/Circuit/DLQ/Lock/Ingress/Idempotency).
--
-- Source of truth: /specs/15-actant-index.md, 16-protocols.md,
-- 17-observability.md, 18-reliability-primitives.md.
-- Mirrored into /specs/02-data-model.sql §17.
-- ============================================================================
...
-- Verification
-- ----------------------------------------------------------------------------
--  * Every table in /specs/15-actant-index.md, 16-protocols.md,
--    17-observability.md, 18-reliability-primitives.md appears here.
--  * Every ALTER TABLE here is non-destructive.
--  * Phase 1 schema unchanged; Phase 2 schema unchanged; only new tables and
--    new columns.
