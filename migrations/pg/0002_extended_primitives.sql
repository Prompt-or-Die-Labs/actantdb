-- ============================================================================
-- 0002_extended_primitives.sql -- Postgres flavor of the Phase 2+ schema delta.
--
-- 1:1 parity with /migrations/0002_extended_primitives.sql (SQLite).
-- TEXT for timestamps, INTEGER for booleans, no JSONB / TIMESTAMPTZ -- see
-- the top of pg/0001_initial.sql for the conventions and why.
-- ============================================================================
...
-- observation.capsule_id remains a documented (unconstrained) reference for
-- parity with the SQLite migration, where the FK could not be added without
-- a table rebuild. Enforcement lives in actant-storage's model layer.
