//! Cross-actor isolation property test for the cache module.
//!
//! NOTE — limits of this test:
//! The v0.1 `ActantCache` type is namespace-agnostic: its public surface is
//! `get(&str) -> Option<String>` and `put(String, String)`. There is no
//! actor or sensitivity parameter on the production API. The full
...
use actant_command::cache::ActantCache;
