...
//! - HTTP client invocation (`reqwest::`, `hyper::`, raw `http::` client use)
//!
...
const FORBIDDEN_PATTERNS: &[&str] = &[
    ...
    "reqwest::",
    "hyper::",
    // `http::` is the raw HTTP types crate — its presence here would imply
    // direct HTTP plumbing rather than an effect handler.
    "http::",
];
