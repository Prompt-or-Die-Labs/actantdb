...
//! `crates/actant-throttle/src/lib.rs` ships only the token-bucket
...
#[test]
#[ignore = "TODO: leaky-bucket algorithm not implemented in actant-throttle"]
fn leaky_bucket_pos_neg_placeholder() {}

#[test]
#[ignore = "TODO: fixed-window algorithm not implemented in actant-throttle"]
fn fixed_window_pos_neg_placeholder() {}

#[test]
#[ignore = "TODO: sliding-window algorithm not implemented in actant-throttle"]
fn sliding_window_pos_neg_placeholder() {}

#[test]
#[ignore = "TODO: concurrency-semaphore algorithm not implemented in actant-throttle"]
fn concurrency_pos_neg_placeholder() {}

#[test]
#[ignore = "TODO: weighted-fair-queue algorithm not implemented in actant-throttle"]
fn wfq_pos_neg_placeholder() {}

#[test]
#[ignore = "TODO: priority queue algorithm not implemented in actant-throttle"]
fn priority_pos_neg_placeholder() {}

#[test]
#[ignore = "TODO: deadline queue algorithm not implemented in actant-throttle"]
fn deadline_pos_neg_placeholder() {}

#[test]
#[ignore = "TODO: adaptive (provider-header driven) algorithm not implemented in actant-throttle"]
