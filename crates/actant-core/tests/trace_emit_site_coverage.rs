...
#[test]
#[ignore = "TODO: spec 17 §1 lists 22 span emit sites; the actant-core trace module currently only mints trace/span ids. Full span emitters (model.call, tool.call, workflow.run, ...) are not yet implemented."]
