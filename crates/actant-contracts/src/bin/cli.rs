...
fn cmd_codegen_ts(extra: Vec<String>) -> Result<(), String> {
    ...
    // Emit index.ts.
    let index = "// AUTO-GENERATED by `cargo run -p actant-contracts --bin actant-contracts -- codegen-ts`.\n\
...
fn repo_root() -> PathBuf {
    // `cargo run -p actant-contracts --bin actant-contracts -- codegen-ts` runs in the workspace root.
