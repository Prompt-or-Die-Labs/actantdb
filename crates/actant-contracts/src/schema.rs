...
pub fn schemas() -> Value {
    json!({
        ...
        "Embedding":           one::<crate::Embedding>(),
        "ActantHotToolCall":   one::<crate::ActantHotToolCall>(),
        "ActantPromptVersion": one::<crate::ActantPromptVersion>(),
        "ActantPromptTemplate":one::<crate::ActantPromptTemplate>(),
        "ActantModelInfo":     one::<crate::ActantModelInfo>(),
        "ActantModelRegistry": one::<crate::ActantModelRegistry>(),
        "ActantIndexedItem":   one::<crate::ActantIndexedItem>(),
        "ActantHit":           one::<crate::ActantHit>(),
        "ActantSearchMode":    one::<crate::ActantSearchMode>(),
        "ActantSearchOptions": one::<crate::ActantSearchOptions>(),
        "ActantSearchHit":     one::<crate::ActantSearchHit>(),
        "ActantEntityRelation":one::<crate::ActantEntityRelation>(),
        "ActantIndex":         one::<crate::ActantIndex>(),
        "ActantMcpServer":     one::<crate::ActantMcpServer>(),
        "ActantA2aCard":       one::<crate::ActantA2aCard>(),
        "ActantAp2Mandate":    one::<crate::ActantAp2Mandate>(),
        "MemoryAllowed":       one::<crate::MemoryAllowed>(),
        "ActantCapsule":       one::<crate::ActantCapsule>(),
        "ActantTrustProfile":  one::<crate::ActantTrustProfile>(),
    })
}
